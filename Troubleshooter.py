...
if choice == 3:
 ...
 print('')
 print('Or use our beta cloud reporting service, DirectReport, which is currently coming soon in 0.13')
...
if choice == 4 :
 print(Fore.LIGHTRED_EX + ' ')
 print('This application is currently created by:')
 print(Fore.LIGHTBLUE_EX + 'byronbytes (byron#0289) ')
 print('')
 print(Fore.RED + 'localtechnerd (Side#6776)')
 print('')
 print('')
 print(Fore.LIGHTWHITE_EX + 'Current Version: v1.2.1')
